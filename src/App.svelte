...
<main class="max-w-md w-full max-h-screen h-screen bg-slate-700 mx-auto flex flex-col">
  ...
  <div on:mouseup={shuffle} class="flex items-center justify-center space-x-2 mx-auto border max-w-sm w-full font-serif active:bg-white active:text-yellow-500 text-white">
